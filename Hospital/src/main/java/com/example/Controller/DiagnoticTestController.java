...
//	}
	...
	public DiagnosticTest upadteTest(@RequestBody DiagnosticTest diagnosticTest,@PathVariable(name="id")int id) {
		DiagnosticTest diagnosticTest2=this.service.getById(id);
